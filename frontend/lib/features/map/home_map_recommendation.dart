                    ...
                    children: ['kafe', 'restoran', 'benzinlik'].map((k) {
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Text(
                            {'kafe': 'Kafe', 'restoran': 'Restoran', 'benzinlik': 'Benzinlik'}[k]!,
                            style: TextStyle(
                  ...
                  onPressed: () {
                    ...
                    final aramaMetni = localKategori == 'kafe'
                        ...
                        : localKategori == 'benzinlik'
                            ? (input.isNotEmpty ? '$input benzinlik' : 'benzinlik')
                    ...
                    _yapayZekaOnerisiCek(
                        aramaMetni, secilenMesafe, rLat, rLng);
                  },
                  child: const Row(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                icon: Icon(_isSimulationMode
                    ? Icons.play_arrow_rounded
                    : Icons.navigation_rounded),
                label: Text(
                  _isSimulationMode ? "Simülasyonu Başlat" : "Navigasyona Geç",
                  style: const TextStyle(
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                onPressed: () {
                  ...
                  _yapayZekaOnerisiCek(_lastOneriArama, _lastOneriMesafe, lat, lng,
                      isRetry: true);
                },
